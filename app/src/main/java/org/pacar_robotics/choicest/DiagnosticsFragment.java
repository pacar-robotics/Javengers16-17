...
public class DiagnosticsFragment extends Fragment {
	...
	@BindViews({R.id.forwards_platform, R.id.backwards_platform, R.id.right_platform, R.id.left_platform, R.id.diagonal_platform})
	List<CheckBox> platformMotors;
	@BindViews({R.id.intake_gate_servo_front, R.id.intake_gate_servo_rear, R.id.beacon_servo_left, R.id.beacon_servo_right, R.id.capball_servo})
	List<CheckBox> servosList;
	@BindViews({R.id.floor_color_sensor, R.id.beacon_color_sensor_left, R.id.beacon_color_sensor_right, R.id.launcher_limit_touch_sensor, R.id.lift_limit_touch_sensor, R.id.ultrasonic_sensor, R.id.eopd_sensor, R.id.gyro_sensor})
