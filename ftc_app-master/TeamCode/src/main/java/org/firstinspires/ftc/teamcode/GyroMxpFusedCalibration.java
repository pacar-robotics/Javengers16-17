...
@TeleOp(name = "GyroMxpFusedCalibrationOp", group = "Calibrations")
public class GyroMxpFusedCalibration extends vv_OpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        vvLib.turnAbsoluteMxpFusedGyroDegrees(this, 90);
        ...
        vvLib.turnAbsoluteMxpFusedGyroDegrees(this, 180);
