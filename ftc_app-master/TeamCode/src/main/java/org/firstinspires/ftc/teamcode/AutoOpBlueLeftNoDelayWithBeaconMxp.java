...
@Autonomous(name = "BlueLeftBeaconNoDelayMxpOp", group = "HorshamTest")
public class AutoOpBlueLeftNoDelayWithBeaconMxp extends vv_OpMode {
    vv_Lib vvLib;
    vv_Robot vvRobot;
    ...
    public void basic_auto_strategy() throws InterruptedException {
        ...
        vvLib.turnPidMxpAbsoluteDegrees(this, 0.0f, 1.0f); //with trim
        ...
        vvLib.turnPidMxpAbsoluteDegrees(this, 90.0f, 1.0f); //with trim
...
//conditions that can stop the robot.
    ...
    public class lineDetectCondition implements StopCondition {
    ...
    public class beaconTouchSensorPressedCondition implements StopCondition {
        public boolean StopCondition(vv_OpMode aOpMode) throws InterruptedException {
            return (vvLib.isBeaconTouchSensorPressed(aOpMode));
        }
    }

    public class falseCondition implements StopCondition {
    ...
    public class beaconTouchOrDistanceClosedCondition implements StopCondition {
        public boolean StopCondition(vv_OpMode aOpMode) throws InterruptedException {
            return (vvLib.isBeaconTouchSensorPressed(aOpMode) ||
