...
@Autonomous(name = "BlueLeftWithDelayOp", group = "Horsham")
public class AutoOpBlueLeftWithDelay extends vv_OpMode {
    vv_Lib vvLib;
    vv_Robot vvRobot;
    ...
    public void basic_auto_strategy() throws InterruptedException, vv_Robot.MotorNameNotKnownException {
        ...
        vvLib.moveWheels(this, 18, .9f, SidewaysRight, true);
        Thread.sleep(250);

        vvLib.moveWheels(this, 40, .9f, Backward, true);
        Thread.sleep(250);
