...
@TeleOp(name = "GyroMxpFusedTestOp", group = "Calibrations")
public class GyroMxpFusedTest extends vv_OpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            vvLib.showMxpFusedGyroSensorHeadingOnTelemetry(this, true);
            idle();
        }
