...
@TeleOp(name = "BeaconLeftColorCalibrationOp", group = "Calibrations")

public class BeaconLeftColorCalibration extends vv_OpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            vvLib.showBeaconLeftColorValuesOnTelemetry(this, true);
            processBeacon();
            idle();
        }
