...
@TeleOp(name = "RangeSensorCalibrationOp", group = "Calibrations")
public class RangeSensorCalibration extends vv_OpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            vvLib.showRangeSensorDistanceOnTelemetry(this);
            idle();
        }
